...
console.error = function() {
    document.body.innerHTML += '<div style="position:fixed;bottom:10px;left:10px;background:red;color:white;padding:10px;z-index:10000;max-width:80%;">Error: ' + Array.from(arguments).join(' ') + '</div>';
