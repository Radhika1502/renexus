...
// Mock icon components to replace lucide-react icons
// This is a temporary solution until we can properly import the icons from lucide-react
...
// Add PlayIcon alias for consistency
export const PlayIcon: React.FC<IconProps> = Play;
